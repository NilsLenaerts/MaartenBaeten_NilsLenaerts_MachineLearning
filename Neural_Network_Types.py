...
def main():
    ...
    gray_arrays_train, labels_int_train,j_train = loadData(r"./Data/dice-d4-d6-d8-d10-d12-d20/dice/train")

    x_train = gray_arrays_train
    y_train = labels_int_train

    gray_arrays_test, labels_int_test, j_test = loadData(r"./Data/dice-d4-d6-d8-d10-d12-d20/dice/valid")
